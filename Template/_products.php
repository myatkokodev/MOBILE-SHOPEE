                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-row pt-4 font-size-16 font-baloo">
                                    <div class="col">
                                        <button type="submit" class="btn btn-danger form-control">Proceed To Bye</button>
                                    </div>
                                    <div class="col">
                                    <?php    
                            ...
                            <div class="col-sm-6 py-5">
                                ...
                                <table class="my-3">
                                    ...
                                    <tr class="font-rale font-size-14">
                                        <td>Deal Price</td>
                                        <td class="font-size-20 text-danger">$<span><?php echo $item['item_price'] ?? 0;  ?></span><small class="text-dark font-size-12">&nbsp;&nbsp;inclusive of all text</small></td>
                                    </tr>
                                    <tr class="font-rale font-size-14">
                                        <td>You Save:</td>
                                ...
                                <div id="policy">
                                    <div class="d-flex">
                                        <div class="return text-center mr-5">
                                            ...
                                            <a href="#" class="font-rale font-size-12">10Days<br>Replacement</a>
                                        </div>
                                        <div class="return text-center mr-5">
                                            <div class="font-size-20 my-2 color-second">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="color my-3">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <p class="p-2 color-yellow-bg rounded-circle"><button class="btn font-size-14"></button></p>
                                                <p class="p-2 color-primary-bg rounded-circle"><button class="btn font-size-14"></button></p>
                                                <p class="p-2 color-second-bg rounded-circle"><button class="btn font-size-14"></button></p>
                                            </div>
                                        </div>
                                        <!--End color-->
                                    </div>
                            ...
                            <div class="col-12">
                                ...
                                <p class="font-rale font-size-14">
                                    ...
                                    Sapiente optio sunt provident, accusantium eligendi eius reiciendis animi? 
                                    Laboriosam, optio qui? Numquam, quo fuga. Maiores minus, accusantium velit 
                                    numquam a aliquam vitae vel?
                                </p>
                                <p class="font-rale font-size-14">
                                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
                                    Repellat inventore vero numquam error est ipsa, consequuntur 
