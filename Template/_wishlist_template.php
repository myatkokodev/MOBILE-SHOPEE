                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="qty d-flex pt-2">
                                        ...
                                        <form method="POST">
                                            ...
                                            <button type="submit" name="delete-cart-submit" class="btn font-baloo text-danger pl-0 pr-3 border-right" onclick="return confirm('Are you sure to delete?');">Delete</button>
                                        </form>
